...
public class Streams {
	...
	public static void main(String[] args) {
		...
		Map<Boolean,List<Integer>> collect6 = listOfIntegers.stream().collect(Collectors.partitioningBy(num->num%2==0));
		System.out.println(collect6);
		 ...
		 Map<String,Long> collect8 = Stream.of(inputString.split("")).collect(Collectors.groupingBy(Function.identity(),Collectors.counting()));
		 System.out.println(collect8);
		 
		 List<String> stationeryList = Arrays.asList("Pen", "Eraser", "Note Book", "Pen", "Pencil", "Stapler", "Note Book", "Pencil");
		 
		 Map<String,Long> collect9 = stationeryList.stream().collect(Collectors.groupingBy(Function.identity(),counting()));
		 ...
		 DoubleSummaryStatistics collect12 = decimalList.stream().collect(Collectors.summarizingDouble(Double::doubleValue));
